...
import { servicesProvidedHeadCells } from '../../seed/table-headers';
...
function ServicesProvided() {
    ...
    const fetcher = React.useCallback(
        (page) => {
            postRequest(
                getAllservicesProvidedByPaginationUrl,
                {
                    "query": searchTerm,
                    "sort": orderBy + " " + order,
                    "limit": rowsPerPage,
        ...
        <>
            ...
            {openCreateDialog &&
                <FormDialog
                    ...
                    values={values}
                    url={action === CREATE ? createServiceProvidedUrl : updateServiceProvidedUrl}
                />
            }
            {openDeleteDialog &&
                <DeleteDialog

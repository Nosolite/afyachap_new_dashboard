...
import { periodCycleHeadCells } from '../../seed/table-headers';
import { filterItems } from '../../utils/constant';
import { postRequest } from '../../services/api-service';
import { getAllPeriodEventsUrl } from '../../seed/url';
        ...
        <Container maxWidth={false}>
          <Stack spacing={2}>
            ...
            <CustomTable
              ...
              headCells={periodCycleHeadCells}
              isLoading={isLoading}
            />
          </Stack>
        </Container>

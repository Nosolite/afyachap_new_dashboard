...
import { subCategoriesHeadCells } from '../../seed/table-headers';
import PencilIcon from '@heroicons/react/24/outline/PencilIcon';
import TrashIcon from '@heroicons/react/24/outline/TrashIcon';
import { DeleteDialog } from '../../components/delete-dialog';
import { CREATE, UPDATE, filterItems } from '../../utils/constant';
import { FormDialog } from '../../components/form-dialog';
import { subCategoriesFields } from '../../seed/form-fields';
import { postRequest } from '../../services/api-service';
import { createSubCategoryUrl, deleteSubCategoryUrl, getAllSubCategoriesByPaginationUrl, updateSubCategoryUrl } from '../../seed/url';
...
function ViewCategories({ open, handleClose, selected }) {
    ...
    const values = [
        {
            SubcategoryId: action === UPDATE ? contentCategorySelection.selected[0].id : 0,
            ...
            image: action === UPDATE ? contentCategorySelection.selected[0].image_url : null,
        }
    ]
    ...
    const fetcher = React.useCallback(
        (page) => {
            postRequest(
                getAllSubCategoriesByPaginationUrl,
                {
                    "query": searchTerm,
    ...
    const handleDelete = async () => {
        postRequest(
            ...
            {
                SubcategoryId: contentCategorySelection.selected[0].id,
            },
            (data) => {
                ...
                <>
                    ...
                    {openCreateDialog &&
                        <FormDialog
                            ...
                            values={values}
                            url={action === CREATE ? createSubCategoryUrl : updateSubCategoryUrl}
                        />
                    }
                    {openDeleteDialog &&
                        <DeleteDialog
                        ...
                        <Container maxWidth="xl">
                            <Stack spacing={2}>
                                ...
                                <CustomTable
                                    ...
                                    headCells={subCategoriesHeadCells}

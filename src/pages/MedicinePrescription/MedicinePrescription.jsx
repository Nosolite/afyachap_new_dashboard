...
import { medicinePrescriptionHeadCells } from '../../seed/table-headers';
import { filterItems } from '../../utils/constant';
import { postRequest } from '../../services/api-service';
import { getAllMedicinePrescriptionsUrl } from '../../seed/url';
...
function MedicinePrescription() {
  ...
  const fetcher = React.useCallback(
    (page) => {
      postRequest(
        getAllMedicinePrescriptionsUrl,
        {
          "query": searchTerm,
          "sort": orderBy + " " + order,
          "limit": rowsPerPage,
        ...
        <Container maxWidth={false}>
          <Stack spacing={2}>
            ...
            <CustomTable
              ...
              headCells={medicinePrescriptionHeadCells}
              isLoading={isLoading}
            />
          </Stack>
        </Container>

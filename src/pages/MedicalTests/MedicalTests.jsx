...
import { medicalTestsHeadCells } from '../../seed/table-headers';
import PencilIcon from '@heroicons/react/24/outline/PencilIcon';
import TrashIcon from '@heroicons/react/24/outline/TrashIcon';
import { DeleteDialog } from '../../components/delete-dialog';
import { CREATE, UPDATE, filterItems } from '../../utils/constant';
import { FormDialog } from '../../components/form-dialog';
import { medicalTestsFields } from '../../seed/form-fields';
import { postRequest } from '../../services/api-service';
import { createTestUrl, deleteTestUrl, getAllMedicalTestsUrl, updateTestUrl } from '../../seed/url';
  ...
  const values = [
    {
      ...
      code: action === UPDATE ? diseaseSelection.selected[0].code : "",
      name: action === UPDATE ? diseaseSelection.selected[0].name : "",
      category: action === UPDATE ? diseaseSelection.selected[0].category : "",
    }
  ]
    ...
    <>
      ...
      {openCreateDialog &&
        <FormDialog
          ...
          dialogTitle={"Medical Test"}
          action={action}
          fields={medicalTestsFields}
          values={values}
          url={action === CREATE ? createTestUrl : updateTestUrl}
        />
      }
      {openDeleteDialog &&
        <DeleteDialog
        ...
        <Container maxWidth={false}>
          <Stack spacing={2}>
            ...
            <CustomTable
              ...
              headCells={medicalTestsHeadCells}

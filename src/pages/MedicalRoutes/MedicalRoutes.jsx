...
import { medicalRoutesHeadCells } from '../../seed/table-headers';
import PencilIcon from '@heroicons/react/24/outline/PencilIcon';
import TrashIcon from '@heroicons/react/24/outline/TrashIcon';
import { DeleteDialog } from '../../components/delete-dialog';
import { CREATE, UPDATE, filterItems } from '../../utils/constant';
import { FormDialog } from '../../components/form-dialog';
import { medicalRoutesFields } from '../../seed/form-fields';
import { postRequest } from '../../services/api-service';
import { createRouteUrl, deleteRouteUrl, getAllMedicalRoutesUrl, updateRouteUrl } from '../../seed/url';
    ...
    <>
      ...
      {openCreateDialog &&
        <FormDialog
          ...
          dialogTitle={"Medical Route"}
          action={action}
          fields={medicalRoutesFields}
          values={values}
          url={action === CREATE ? createRouteUrl : updateRouteUrl}
        />
      }
      {openDeleteDialog &&
        <DeleteDialog
        ...
        <Container maxWidth={false}>
          <Stack spacing={2}>
            ...
            <CustomTable
              ...
              headCells={medicalRoutesHeadCells}

...
import { medicalSchedulesHeadCells } from '../../seed/table-headers';
import PencilIcon from '@heroicons/react/24/outline/PencilIcon';
import TrashIcon from '@heroicons/react/24/outline/TrashIcon';
import { DeleteDialog } from '../../components/delete-dialog';
import { CREATE, UPDATE, filterItems } from '../../utils/constant';
import { FormDialog } from '../../components/form-dialog';
import { medicalSchedulesFields } from '../../seed/form-fields';
import { postRequest } from '../../services/api-service';
import { createScheduleUrl, deleteScheduleUrl, getAllMedicalSchedulesUrl, updateScheduleUrl } from '../../seed/url';
    ...
    <>
      ...
      {openCreateDialog &&
        <FormDialog
          ...
          dialogTitle={"Medical Schedule"}
          action={action}
          fields={medicalSchedulesFields}
          values={values}
          url={action === CREATE ? createScheduleUrl : updateScheduleUrl}
        />
      }
      {openDeleteDialog &&
        <DeleteDialog
        ...
        <Container maxWidth={false}>
          <Stack spacing={2}>
            ...
            <CustomTable
              ...
              headCells={medicalSchedulesHeadCells}

...
import { contentSubscribersHeadCells } from '../../seed/table-headers';
import { filterItems } from '../../utils/constant';
import { postRequest } from '../../services/api-service';
import { getAllContentSubscribersByPaginationUrl } from '../../seed/url';
...
function ContentSubscribers() {
    ...
    const fetcher = React.useCallback(
        (page) => {
            postRequest(
                getAllContentSubscribersByPaginationUrl,
                {
                    "query": searchTerm,
                    "sort": orderBy + " " + order,
                    "limit": rowsPerPage,
                ...
                <Container maxWidth={false}>
                    <Stack spacing={2}>
                        ...
                        <CustomTable
                            ...
                            headCells={contentSubscribersHeadCells}
                            isLoading={isLoading}
                        />
                    </Stack>
                </Container>
...
export default ContentSubscribers
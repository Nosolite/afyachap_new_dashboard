...
import { interestsHeadCells } from '../../seed/table-headers';
...
import { interestsFormFields } from '../../seed/form-fields';
import { createInterestUrl, deleteInterestUrl, getAllInterestsByPaginationUrl, updateInterestUrl } from '../../seed/url';
...
function Interests() {
    ...
    const values = [
        {
            ...
            interest_name: action === UPDATE ? productCategoriesSelection.selected[0].interest_name : "",
        }
    ]
    ...
    const fetcher = React.useCallback(
        (page) => {
            authPostRequest(
                getAllInterestsByPaginationUrl,
                {
                    "query": searchTerm,
                    "sort": orderBy + " " + order,
                    "limit": rowsPerPage,
        ...
        <>
            ...
            {openCreateDialog &&
                <FormDialog
                    ...
                    dialogTitle={"Interest"}
                    action={action}
                    fields={interestsFormFields}
                    values={values}
                    url={action === CREATE ? createInterestUrl : updateInterestUrl}
                />
            }
            {openDeleteDialog &&
                <DeleteDialog

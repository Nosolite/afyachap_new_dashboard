...
import { datingUsersChatsHeadCells } from '../../seed/table-headers';
import EyeIcon from '@heroicons/react/24/outline/EyeIcon';
import { filterItems } from '../../utils/constant';
import { getAllRegisteredDatingUsersChatsByPaginationUrl } from '../../seed/url';
...
function DatingUsersChats() {
    ...
    const fetcher = React.useCallback(
        (page) => {
            authPostRequest(
                getAllRegisteredDatingUsersChatsByPaginationUrl,
                {
                    "query": searchTerm,
                    "sort": orderBy + " " + order,
                    "limit": rowsPerPage,
                ...
                <Container maxWidth={false}>
                    <Stack spacing={2}>
                        ...
                        <CustomTable
                            ...
                            headCells={datingUsersChatsHeadCells}
...
export default DatingUsersChats